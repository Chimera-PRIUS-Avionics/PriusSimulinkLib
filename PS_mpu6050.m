classdef PS_mpu6050 < matlab.System ...
    ...
    methods
        % Constructor
        function obj = PS_mpu6050a(varargin)
    ...
    methods (Static)
        ...
        function updateBuildInfo(buildInfo, context)
            ...
            libDir =  fullfile(fileparts(mfilename('fullpath')),'build', 'mpu6050', 'src');
